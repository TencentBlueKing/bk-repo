...
$BK_REPO_HOME/scripts/render_tpl -u -p $BK_REPO_HOME -m . -e repo.env -E BK_REPO_RELEASE_MODE=assembly $BK_REPO_HOME/support-files/templates/frontend#ui#index.html
