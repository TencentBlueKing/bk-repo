# Contributing to BK-CI/BK-REPO

蓝鲸团队秉持开放的态度，欢迎志同道合的开发者一起贡献项目。在开始之前，请认真阅读以下指引。

## 代码协议

[MIT LICENSE](LICENSE.txt) 为 BK-CI/BK-REPO 的开源协议，任何人贡献的代码也会受此协议保护，贡献代码前也请明确是否可以接受该协议。
...
如果想对BK-CI/BK-REPO项目贡献功能与特性，请参考以下步骤：
...
相关的review流程请参照：[BK-CI/BK-REPO review相关流程](./docs/specification/review.md)

## Issues

蓝鲸团队使用[issues](https://github.com/TencentBlueKing/bk-repo/issues)进行bugs追踪、特性追踪等。
