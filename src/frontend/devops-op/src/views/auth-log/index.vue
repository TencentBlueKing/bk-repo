  ...
  <div class="app-container">
    ...
    <div class="app">
      <el-table v-loading="loading" :data="tableData" style="width: 100%;">
        ...
        <el-table-column prop="operate" label="操作事件" width="200" header-align="center" align="center" />
        <el-table-column prop="description" label="操作内容" width="1000" header-align="center" align="center" />
...
export default {
  ...
  methods: {
    ...
    onRouteUpdate(route) {
      ...
      if (authLogQuery.startTime === '') authLogQuery.startTime = query.startTime ? query.startTime : null
      if (authLogQuery.endTime === '') authLogQuery.endTime = query.endTime ? query.endTime : null
      if (authLogQuery.userId === '') authLogQuery.userId = query.userId ? query.userId : null
      this.$nextTick(() => {
    ...
    queryAuthLog(authLogQuery) {
      this.loading = true
      let promise = null
      promise = page(authLogQuery.pageNumber, authLogQuery.pageSize, authLogQuery.startTime, authLogQuery.endTime, authLogQuery.userId)
      promise.then(res => {
