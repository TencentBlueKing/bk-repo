<template>
  <div class="app-container node-container">
    <el-form ref="form" :inline="true" :model="clientQuery">
      ...
      <el-form-item style="margin-left: 15px" label="日期" prop="heartbeatTime">
    ...
    <el-table v-loading="loading" :data="clients" style="width: 100%">
      ...
      <el-table-column prop="heartbeatTime" label="当天最近一次心跳时间">
...
export default {
  ...
  methods: {
    ...
    onRouteUpdate(route) {
      ...
      clientQuery.heartbeatTime = query.heartbeatTime ? query.heartbeatTime : ''
      this.$nextTick(() => {
