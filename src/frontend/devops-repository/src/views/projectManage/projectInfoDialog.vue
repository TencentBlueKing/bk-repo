        ...
        <bk-form class="ml10 mr10" :label-width="75" :model="editProjectDialog" :rules="rules" ref="projectInfoForm">
            <bk-form-item :label="$t('projectId')" :required="true" property="id" error-display-type="normal">
                <bk-input v-model.trim="editProjectDialog.id"
                    ...
                    show-word-limit
                    :placeholder="$t('Please enter a combination of 2-100 characters of lowercase letters, numbers, -, _, starting with a letter')">
                </bk-input>
            </bk-form-item>
                ...
                rules: {
                    id: [
                        ...
                        },
                        {
                            ...
                            message: this.$t('Please enter a combination of 2-100 characters of lowercase letters, numbers, -, _, starting with a letter'),
                            trigger: 'blur'
                        },
                        {
