...
import com.tencent.bkrepo.nuget.artifact.NugetArtifactInfo.Companion.SEARCH
...
@RequestMapping(NUGET_ROOT_URI_V3, produces = [MediaTypes.APPLICATION_JSON])
@RestController
class NugetSearchController(
    private val nugetSearchService: NugetSearchService
) {
    @GetMapping(SEARCH, produces = [MediaTypes.APPLICATION_JSON])
