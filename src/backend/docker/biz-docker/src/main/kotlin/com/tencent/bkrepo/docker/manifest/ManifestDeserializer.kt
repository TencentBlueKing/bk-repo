...
class ManifestDeserializer {
    companion object {
        ...
        fun deserialize(repo: DockerArtifactService, pathContext: RequestContext, tag: String, manifestType: ManifestType, bytes: ByteArray, digest: DockerDigest): ManifestMetadata {
