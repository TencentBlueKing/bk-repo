...
import com.tencent.bkrepo.udt.anno.Native;
import com.tencent.bkrepo.udt.lib.LibraryLoader;
...
public class SocketUDT {
     ...
     * {@link com.tencent.bkrepo.udt.nio.SelectorUDT#select()} operation; see epoll.h
     * to confirm current limit
     */
    public static final int DEFAULT_MAX_SELECTOR_SIZE = 1024;

    /**
     * Minimum timeout of a {@link com.tencent.bkrepo.udt.nio.SelectorUDT#select()}
     * operations.
     */
    ...
    static {
        ...
        try {
            ...
            @SuppressWarnings("unchecked") final Class<LibraryLoader> loaderClass = //
