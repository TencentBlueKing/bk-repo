...
class PackageQueryBuilder : AbstractQueryBuilder() {
     ...
     * 添加包唯一key规则
     */
    fun key(value: String, operation: OperationType = OperationType.EQ): AbstractQueryBuilder {
     ...
     * 添加类型规则
     */
    fun type(value: String, operation: OperationType = OperationType.EQ): AbstractQueryBuilder {
