...
interface RepositoryResource {
    ...
    fun detail(
            @ApiParam(value = "仓库id")
            @PathVariable id: String): Response<Repository>

    @ApiOperation("列表查询项目所有仓库")
    @GetMapping("/list/{projectId}")
    fun list(
            @ApiParam(value = "项目id")
            @PathVariable projectId: String): Response<List<Repository>>
    ...
    fun page(
            ...
            @ApiParam(value = "项目id")
            @PathVariable projectId: String): Response<Page<Repository>>

    @ApiOperation("创建仓库")
    @PostMapping
    fun create(
            @ApiParam(value = "仓库信息")
            @RequestBody repository: Repository): Response<Repository>
    ...
    fun update(
            ...
            @ApiParam(value = "仓库信息")
            @RequestBody repository: Repository): Response<Boolean>
