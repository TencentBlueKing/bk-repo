...
class PackageQueryBuilder {
     ...
     * 设置查询字段[fields]
     */
    fun select(vararg fields: String): PackageQueryBuilder {
     ...
     * 按字段[fields]降序排序
     */
    fun sortByAsc(vararg fields: String): PackageQueryBuilder {
     ...
     * 按字段[fields]升序排序
     */
    fun sortByDesc(vararg fields: String): PackageQueryBuilder {
     ...
     */
    fun sort(direction: Sort.Direction, vararg fields: String): PackageQueryBuilder {
        if (fields.isNotEmpty()) {
     ...
     */
    fun page(pageNumber: Int, pageSize: Int): PackageQueryBuilder {
     ...
     * 设置项目id为[projectId]
     */
    fun projectId(projectId: String): PackageQueryBuilder {
     ...
     * 设置仓库名称为[repoName]
     */
    fun repoName(repoName: String): PackageQueryBuilder {
     ...
     * 设置多个仓库
     */
    fun repoNames(vararg repoNames: String): PackageQueryBuilder {
     ...
     * 设置仓库类型为[repoType]
     */
    fun repoType(repoType: RepositoryType): PackageQueryBuilder {
     ...
     */
    fun rule(field: String, value: Any, operation: OperationType = OperationType.EQ): PackageQueryBuilder {
     ...
     * [field]为字段名称，[value]为值，[operation]为查询操作类型，默认为EQ查询
     */
    fun rule(condition: Boolean, field: String, value: Any, operation: OperationType = OperationType.EQ): PackageQueryBuilder {
        if (condition) {
     ...
     */
    fun metadata(key: String, value: Any, operation: OperationType = OperationType.EQ): PackageQueryBuilder {
     ...
     *
     */
    fun stage(stage: ArtifactStageEnum, operation: OperationType = OperationType.EQ): PackageQueryBuilder {
     ...
     * [value]为值，[operation]为查询操作类型，默认为EQ查询
     */
    fun path(value: String, operation: OperationType = OperationType.EQ): PackageQueryBuilder {
     ...
     * [value]为值，[operation]为查询操作类型，默认为EQ查询
     */
    fun fullPath(value: String, operation: OperationType = OperationType.EQ): PackageQueryBuilder {
     ...
     * [value]为值，[operation]为查询操作类型，默认为EQ查询
     */
    fun size(value: Long, operation: OperationType = OperationType.EQ): PackageQueryBuilder {
     ...
     * 排除目录
     */
    fun excludeFolder(): PackageQueryBuilder {
     ...
     * 排除文件
     */
    fun excludeFile(): PackageQueryBuilder {
