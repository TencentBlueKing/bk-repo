...
class ArchiveMetrics(
    ...
    companion object {
        ...
        private const val ARCHIVE_FILE_STATUS_COUNTER = "file.status.count"
        private const val ARCHIVE_FILE_STATUS_COUNTER_DESC = "文件状态统计"
        private const val COMPRESS_FILE_STATUS_COUNTER = "file.status.count"
        private const val COMPRESS_FILE_STATUS_COUNTER_DESC = "文件状态统计"
        private const val FILE_COMPRESSED_COUNTER = "file.compress.size.count"
        ...
        private const val FILE_UNCOMPRESSED_COUNTER = "file.compress.size.count"
