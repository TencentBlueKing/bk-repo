...
interface PackageDependentResource {
    ...
    fun dependentMigrationByUrl(@ArtifactPathVariable artifactInfo: NpmArtifactInfo): NpmDataMigrationResponse<String>

    @ApiOperation("package dependent migration by file")
    @GetMapping("/{projectId}/{repoName}/dependentMigrationByFile")
    fun dependentMigrationByFile(@ArtifactPathVariable artifactInfo: NpmArtifactInfo): NpmDataMigrationResponse<String>
}
