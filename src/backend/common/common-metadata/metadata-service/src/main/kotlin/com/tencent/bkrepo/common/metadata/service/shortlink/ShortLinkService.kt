...
interface ShortLinkService {
     ...
     * 创建短链接
     */
    fun create(request: ShortLinkCreateRequest): ShortLink

    /**
     * 解析短码为目标绝对 URL；不存在抛 404，过期抛 410
     */
    fun resolve(code: String, scheme: String, host: String): String

    /**
     * 按短码查询（含已过期记录）
     */
    fun get(code: String): ShortLink?
     ...
     * 按创建人分页查询
     */
    fun listByCreator(option: ShortLinkListOption): Page<ShortLink>
}
