...
class NodeScatterQueryServiceTest {
    ...
    fun `scatterFind merges results from Default and Heavy instances`() {
        ...
        whenever(registry.secondaryTemplateByInstance("node", "heavy1")).thenReturn(heavy1Template)
    ...
    fun `scatterFind returns partial results when one instance times out in DEGRADE mode`() {
        ...
        whenever(registry.secondaryTemplateByInstance("node", "heavy1")).thenReturn(slowTemplate)
    ...
    fun `scatterFind throws in STRICT mode when one instance throws`() {
        ...
        whenever(registry.secondaryTemplateByInstance("node", "heavy1")).thenReturn(failingTemplate)
