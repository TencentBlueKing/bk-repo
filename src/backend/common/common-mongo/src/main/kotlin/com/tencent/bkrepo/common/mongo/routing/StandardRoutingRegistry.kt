...
class StandardRoutingRegistry(
    ...
    override fun resolveOplog(): RoutedTemplate = defaultRouted()
    ...
    override fun allSecondaryTemplates(ruleName: String): Map<String, MongoTemplate> = emptyMap()
    ...
    private fun defaultRouted(): RoutedTemplate =
        RoutedTemplate(DEFAULT_INSTANCE, defaultTemplate, defaultTemplate)
