 ...
 * URL下载带宽限流服务
 */
class UrlDownloadBandwidthRateLimiterService(
    ...
    override fun getLimitDimensions(): List<String> {
        return listOf(LimitDimension.URL_DOWNLOAD_BANDWIDTH.name)
    }

    override fun getRateLimitRuleClass(): Class<out RateLimitRule> {
        return UrlDownloadBandwidthRateLimitRule::class.java
    }

    override fun generateKey(resource: String, resourceLimit: ResourceLimit): String {
        return KEY_PREFIX + "UrlDownloadBandwidth:$resource"
    }
