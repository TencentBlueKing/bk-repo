 ...
 */
class UrlPrefixUploadBandwidthRateLimiterService(
    ...
    override fun getLimitDimensions(): List<String> {
        return listOf(LimitDimension.URL_PREFIX_UPLOAD_BANDWIDTH.name)
    }

    override fun getRateLimitRuleClass(): Class<out RateLimitRule> {
        return UrlPrefixUploadBandwidthRateLimitRule::class.java
    }
    ...
    override fun generateKey(resource: String, resourceLimit: ResourceLimit): String {
        return KEY_PREFIX + "UrlPrefixUploadBandwidth:${resourceLimit.resource}"
    }
